...
public class Menu1Sub1Contoller {
    ...
    private final Menu1Sub1Service menu1Sub1Service;
    ...
    public ResponseEntity<CiamsTechLQDto.HighTech.Find.Result> getHighTech(@Param("params") @RequestBody
        ...
        CiamsTechLQDto.HighTech.Find.Result result = menu1Sub1Service.getHighTech(params);
    ...
    public ResponseEntity<List<CiamsTechLQDto.TechLQ.Find.Result>> getTechLQ(@Param("params") @RequestBody
        ...
        List<CiamsTechLQDto.TechLQ.Find.Result> result = menu1Sub1Service.getTechLQ(params);
        return ResponseEntity.ok(result);
    }
}
