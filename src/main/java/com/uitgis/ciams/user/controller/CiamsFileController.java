...
//    public ResponseEntity<?> viewImageByName(@PathVariable("name") String name) {
//        File imageFile = FileUtil.getFile(CiamsImage.builder()
//                .path("temp")
//                .name(name)
//                .build());
//
...
//    }
    ...
    public ResponseEntity<List<CiamsFile>> uploadEditorImages(@ModelAttribute CiamsFileDto.EditorImage.Upload params) throws Exception {
        List<CiamsFile> tempFiles = ciamsFileService.uploadEditorImages(params);
