...
DROP TABLE IF EXISTS ciams_incen;
DROP TABLE IF EXISTS ciams_incen_loc;
...
-- 인센티브
CREATE TABLE ciams_incen
(
	-- 인센티브 고유번호
	incen_id varchar(36) NOT NULL,
	-- 민원접수번호
	reg_no varchar(36),
	-- 건축인허가번호
	lic_building varchar(36),
	-- 개발행위허가번호
	lic_develop varchar(36),
	-- 인센티브상태
	status varchar(5),
	-- 신청면적
	area numeric,
	...
	del_yn varchar(2),
	-- 용도지역코드
	area_use_cd varchar(5),
	-- 용도지역명
	area_use_nm varchar(36),
	PRIMARY KEY (incen_id)
) WITHOUT OIDS;


-- 인센티브 대상지
CREATE TABLE ciams_incen_loc
(
	-- 인센티브대상지고유번호
	incen_loc_id varchar(36) NOT NULL,
	-- 인센티브고유번호
	incen_id varchar(36),
	-- pnu
	pnu varchar(19),
...
COMMENT ON TABLE ciams_incen IS '인센티브';
COMMENT ON COLUMN ciams_incen.incen_id IS '인센티브 고유번호';
COMMENT ON COLUMN ciams_incen.reg_no IS '민원접수번호';
COMMENT ON COLUMN ciams_incen.lic_building IS '건축인허가번호';
COMMENT ON COLUMN ciams_incen.lic_develop IS '개발행위허가번호';
COMMENT ON COLUMN ciams_incen.status IS '인센티브상태';
COMMENT ON COLUMN ciams_incen.area IS '신청면적';
COMMENT ON COLUMN ciams_incen.struc IS '공사물구조';
COMMENT ON COLUMN ciams_incen.plan_id IS '성장관리계획고유번호';
COMMENT ON COLUMN ciams_incen.plan_area_id IS '성장관리지역고유번호';
COMMENT ON COLUMN ciams_incen.xy IS '대상지 지오메트리';
COMMENT ON COLUMN ciams_incen.reg_date IS '등록일';
COMMENT ON COLUMN ciams_incen.reg_user IS '등록자ID';
COMMENT ON COLUMN ciams_incen.del_yn IS '삭제유무';
COMMENT ON COLUMN ciams_incen.area_use_cd IS '용도지역코드';
COMMENT ON COLUMN ciams_incen.area_use_nm IS '용도지역명';
COMMENT ON TABLE ciams_incen_loc IS '인센티브 대상지';
COMMENT ON COLUMN ciams_incen_loc.incen_loc_id IS '인센티브대상지고유번호';
COMMENT ON COLUMN ciams_incen_loc.incen_id IS '인센티브고유번호';
COMMENT ON COLUMN ciams_incen_loc.pnu IS 'pnu';
COMMENT ON COLUMN ciams_incen_loc.loc IS '위치';
COMMENT ON COLUMN ciams_incen_loc.jimok IS '지목';
COMMENT ON COLUMN ciams_incen_loc.area IS '면적';
COMMENT ON COLUMN ciams_incen_loc.rep IS '대표대상지유무';
COMMENT ON COLUMN ciams_incen_loc.xy IS '대상지 지오메트리';
...
COMMENT ON COLUMN ciams_plan_content.reg_date IS '등록일';
COMMENT ON COLUMN ciams_plan_content.chg_date IS '수정일';
